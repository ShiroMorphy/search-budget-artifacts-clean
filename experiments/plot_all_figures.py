...
def plot_fig1():
    ...
    ax1.set_ylabel(r'Fraction of Analytical Optimum Attained ($\hat{f} / f^*$, %)')
    ax1.set_ylim(-2, 108)
...
def plot_fig2():
    ...
    ax1.set_ylabel(r'Causal Emergence Density $\Delta J$ (nats per dimension)')
...
def plot_fig3():
    ...
    ax2.plot(df_emp["lambda_0"], df_emp["modal_q_adapt"], 'o-', color='#1b7837', label='Monotone backtracking mode')
